...
[Writing Good User Stories](https://stormotion.io/blog/how-to-write-a-good-user-story-with-examples-templates/) _(user story tips)_

[Guide To Add feature to A Web App](https://git.generalassemb.ly/sei-toronto/SEI-FLEX-46/blob/master/w11/d2/guide-to-add-feature-to-web-app.md) _(Cheatsheet for creating new routes/controllers/etc)_

[Guide to User Centric Crud](https://git.generalassemb.ly/sei-toronto/SEI-FLEX-46/blob/master/w11/d2/guide-to-user-centric-crud.md) _(Great sample routing)_
