exports.performers = [
  ...
  {name: 'Carrie Fisher', born: '10-21-1956', movies:[]},
  {name: 'Mark Hamill', born: '09-25-1951', movies: ['Star Wars - A New Hope']},
  {name: 'Harrison Ford', born: '07-13-1942', movies:['Star Wars - A New Hope']},
  {name: 'Jodie Foster', born: '11-19-1962'},
  {name: 'Matthew McConaughey', born: '11-04-1969'},
  {name: 'James Woods', born: '04-18-1947'},
  {name: 'Anne Hathaway', born: '11-12-1982', movies:['Interstellar']},
  {name: 'Bill Murray', born: '09-21-1950'},
  {name: 'Chevy Chase', born: '10-08-1943', movies:['Caddyshack']},
